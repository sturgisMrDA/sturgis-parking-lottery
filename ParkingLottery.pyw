...
def get_help():
    try: 
        os.startfile('https://docs.google.com/a/sturgischarterschool.org/document/d/1kDdWPdcYB2ztbTGQQhwmLGHz41rpUzJtwBBUdrWezZE')
    except:
        try:
            os.startfile('help.txt')
        except FileNotFoundError:
            messagebox.showerror('Helpless',"Can't find the help file.\nSearch your google docs or contact\nMr. D.A. for instructions.")
def show_credits():
    try:
